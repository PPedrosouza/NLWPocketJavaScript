...
export function Summary() {
  ...
  const lasttDayOfWeek = dayjs().endOf('week').format('D MMM')
                  ...
                  return (
                    <li key={goal.id} className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-zinc-400">
                        Você completou {''}
                        <span className="text-zin-100">{goal.title}</span> às{' '}
                        <span className="text-zin-100">{time}h</span>
                      </span>
                    </li>
                  )
                })}
